...
class PAJ7620U2(object):
	...
	def check_gesture(self):
        ...
        #Gesture player , integer within () are key binding commands
        #https://python-omxplayer-wrapper.readthedocs.io/en/latest/_modules/omxplayer/player/#OMXPlayer.can_pause
